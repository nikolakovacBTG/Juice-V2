...
const _CONCRETE_EFFECTS := "Appearance2DJuiceEffect,CallMethod2DJuiceUtility,Camera2DJuiceEffect,Camera3DJuiceEffect,Noise2DJuiceEffect,Pause2DJuiceEffect,ProgressTransform2DJuiceEffect,SceneAction2DJuiceUtility,ScreenJuiceEffect,ScreenOverlay2DJuiceEffect,Shake2DJuiceEffect,SignalEmit2DJuiceUtility,SquashStretch2DJuiceEffect,Time2DJuiceEffect,TrailJuiceEffect,Transform2DJuiceEffect,VFXJuiceEffect"
