...
const _CONCRETE_EFFECTS := "Appearance2DJuiceEffect,Noise2DJuiceEffect,ScreenOverlay2DJuiceEffect,Shake2DJuiceEffect,Spring2DJuiceEffect,SquashStretch2DJuiceEffect,Transform2DJuiceEffect"
