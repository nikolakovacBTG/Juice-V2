...
const _CONCRETE_EFFECTS := "AppearanceControlJuiceEffect,CallMethodControlJuiceUtility,Camera2DJuiceEffect,Camera3DJuiceEffect,InterpolatePropertyControlJuiceEffect,NoiseControlJuiceEffect,NoisePropertyControlJuiceEffect,ProgressControlJuiceEffect,ProgressPropertyControlJuiceEffect,SceneActionControlJuiceUtility,ScreenJuiceEffect,ScreenOverlayControlJuiceEffect,ShakeControlJuiceEffect,ShakePropertyControlJuiceEffect,SignalEmitControlJuiceUtility,SquashStretchControlJuiceEffect,TimeControlJuiceEffect,TransformControlJuiceEffect"
