...
const _CONCRETE_EFFECTS := "AppearanceControlJuiceEffect,NoiseControlJuiceEffect,ScreenOverlayControlJuiceEffect,ShakeControlJuiceEffect,SpringControlJuiceEffect,SquashStretchControlJuiceEffect,TransformControlJuiceEffect"
