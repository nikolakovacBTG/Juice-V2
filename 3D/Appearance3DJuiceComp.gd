...
func _get_grayscale_shader() -> Shader:
	if _grayscale_shader == null:
		_grayscale_shader = load("res://addons/Juice_V1/Shaders/grayscale_3d.gdshader")
...
func _get_dissolve_shader() -> Shader:
	if _dissolve_shader == null:
		_dissolve_shader = load("res://addons/Juice_V1/Shaders/dissolve_3d.gdshader")
...
func _get_overlay_shader() -> Shader:
	if _overlay_shader == null:
		_overlay_shader = load("res://addons/Juice_V1/Shaders/overlay_3d.gdshader")
