...
## 3. Add JuiceCompBase children/siblings — they'll be driven automatically
...
## Cached list of sibling JuiceCompBase nodes to drive.
...
func _get_configuration_warnings() -> PackedStringArray:
	...
	if not has_juice_sibling:
		warnings.append("No JuiceCompBase siblings found. Add juice components as siblings to be driven by this trigger.")
