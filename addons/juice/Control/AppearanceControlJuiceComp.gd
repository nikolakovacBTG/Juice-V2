...
## ============================================================================
## WHAT: Unified surface appearance effect for Control/CanvasItem nodes.
...
func _get_configuration_warnings() -> PackedStringArray:
	...
	if parent and not parent is Control:
		warnings.append("Parent must be a Control node. Use Appearance2D/3D for other domains. (ignore if comp is a child of a sequencer)")
	return warnings
