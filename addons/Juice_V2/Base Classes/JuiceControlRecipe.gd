...
const _CONCRETE_EFFECTS := "AppearanceControlJuiceEffect,CallMethodControlJuiceUtility,Camera2DJuiceEffect,Camera3DJuiceEffect,PropertyInterpolateControlJuiceEffect,NoiseControlJuiceEffect,PropertyNoiseControlJuiceEffect,PauseControlJuiceEffect,PropertyProgressControlJuiceEffect,ProgressTransformControlJuiceEffect,SceneActionControlJuiceUtility,ScreenJuiceEffect,ScreenOverlayControlJuiceEffect,ShakeControlJuiceEffect,PropertyShakeControlJuiceEffect,SignalEmitControlJuiceUtility,SquashStretchControlJuiceEffect,TimeControlJuiceEffect,TransformControlJuiceEffect,VFXJuiceEffect"
