...
const _CONCRETE_EFFECTS := "Appearance3DJuiceEffect,CallMethod3DJuiceUtility,Noise3DJuiceEffect,Progress3DJuiceEffect,ProgressProperty3DJuiceEffect,ScreenOverlay3DJuiceEffect,Shake3DJuiceEffect,SignalEmit3DJuiceUtility,SquashStretch3DJuiceEffect,Time3DJuiceEffect,Transform3DJuiceEffect"
