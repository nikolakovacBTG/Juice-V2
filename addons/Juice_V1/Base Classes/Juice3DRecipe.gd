...
const _CONCRETE_EFFECTS := "Appearance3DJuiceEffect,Noise3DJuiceEffect,ScreenOverlay3DJuiceEffect,Shake3DJuiceEffect,Spring3DJuiceEffect,SquashStretch3DJuiceEffect,Transform3DJuiceEffect"
