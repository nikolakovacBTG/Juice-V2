...
const _CONCRETE_EFFECTS := "Appearance3DJuiceEffect,CallMethod3DJuiceUtility,Camera2DJuiceEffect,Camera3DJuiceEffect,Noise3DJuiceEffect,Progress3DJuiceEffect,PropertyInterpolate3DJuiceEffect,PropertyNoise3DJuiceEffect,PropertyProgress3DJuiceEffect,PropertyShake3DJuiceEffect,SceneAction3DJuiceUtility,ScreenJuiceEffect,ScreenOverlay3DJuiceEffect,Shake3DJuiceEffect,SignalEmit3DJuiceUtility,SquashStretch3DJuiceEffect,Time3DJuiceEffect,Transform3DJuiceEffect"
