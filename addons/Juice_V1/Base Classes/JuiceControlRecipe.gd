...
const _CONCRETE_EFFECTS := "AppearanceControlJuiceEffect,NoiseControlJuiceEffect,ShakeControlJuiceEffect,SpringControlJuiceEffect,SquashStretchControlJuiceEffect,TransformControlJuiceEffect"
