...
const _CONCRETE_EFFECTS := "Appearance2DJuiceEffect,CallMethod2DJuiceEffect,Noise2DJuiceEffect,Progress2DJuiceEffect,ProgressProperty2DJuiceEffect,ScreenOverlay2DJuiceEffect,Shake2DJuiceEffect,SignalEmit2DJuiceEffect,SquashStretch2DJuiceEffect,Time2DJuiceEffect,Transform2DJuiceEffect"
